...
/* harmony export */   setRangeCurrentElement: () => (/* binding */ setRangeCurrentElement),
...
const setModals = () => {
  ...
  modalButtons.forEach(button => {
    ...
    function loopFocus(evt) {
      ...
      if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.isTabKey)(evt) && evt.shiftKey && document.activeElement === firstFocusableElement) {
        evt.preventDefault();
        lastFocusableElement.focus();
      } else if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.isTabKey)(evt) && !evt.shiftKey && document.activeElement === lastFocusableElement) {
        evt.preventDefault();
...
const setRanges = () => {
  ...
  forms.forEach(form => {
    ...
    singleRanges.forEach(range => {
      ...
      let filterConfig = _vars_js__WEBPACK_IMPORTED_MODULE_1__.RANGE_VALUES[filterType];
      if (!filterConfig) {
        filterConfig = _vars_js__WEBPACK_IMPORTED_MODULE_1__.RANGE_VALUES['default'];
      }
      ...
      const onSliderUpdate = () => {
        ...
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.setRangeCurrentElement)(range, currentElement);
      };
      const createRange = (min, max, step, start) => {
        nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(sliderElement, {
          range: {
            min,
            max
          },
      ...
      createRange(filterConfig.min, filterConfig.max, filterConfig.step, filterConfig.start);
    });
    ranges.forEach(range => {
      ...
      const onSliderUpdate = () => {
        ...
        (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.setRangeCurrentElement)(range, currentElements);
      };
      ...
      createRange(filterConfig.min, filterConfig.max, filterConfig.step, filterConfig.start, filterConfig.end);
    });
  });
};
